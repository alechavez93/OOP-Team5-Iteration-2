...
public class DemoMain {
    public static void main(String[] args) {
        ...
        FortStructure fortStructure = new FortStructure(0,new MapCoordinate(2,7), game.player1.getEntityManager(), 10);
        EntityManager entityManager = game.player1.getEntityManager();
        entityManager.addFort(fortStructure);
